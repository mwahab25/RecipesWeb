...
public partial class Recipes : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            if (Session["LoginCom"] != null && Session["LoginUser"] != null)
            {
                ...
                if (dtpriv.Rows.Count > 0)
                {
                    ...
                    recipe_ingredcat.DataTextField = "IngredientCat_NameEn";
                    ...
                    recipe_batchname.DataTextField = "Batch_NameEn";
    ...
    private void BindCatData()
    {
        try
        {
            ...
            recipe_cat.DataTextField = "RecipeCat_NameEn";
    ...
    protected void recipe_print_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("~/Reports/RecipeGenerate.aspx?id=" + recipe_no.Text);
        }
        catch (Exception ex)
        {
    ...
    protected void recipe_batchcat_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            recipe_ingredname.DataTextField = "Ingredient_NameEn";
    ...
    protected void recipe_sellprice_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-Recipes-recipe_sellprice_TextChanged");
        }
    }
    protected void recipe_target_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-Recipes-recipe_target_TextChanged");
        }
    }
    ...
    private void BindRecipeHowToDo()
    {
        try
        {
            ...
            howtodo_reccat.DataTextField = "RecipeCat_NameEn";
    ...
    protected void howtodo_reccat_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dtu.Rows.Count > 0)
            {
                ...
                howtodo_rec.DataTextField = "Recipe_NameEn";
