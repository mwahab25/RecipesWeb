<%@ Page Title="الخامات" Language="C#" MasterPageFile="~/ar/Site.master" AutoEventWireup="true" CodeFile="Ingredients.aspx.cs" Inherits="ar_Ingredients" %>
<asp:Content ID="Content2" ContentPlaceHolderID="LangContent" runat="server">
     <li class="dropdown"><a href="Ingredients.aspx" class="dropdown-toggle" data-toggle="dropdown">عربي
            <b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li><a href="../Ingredients.aspx">English</a></li>
                <li><a href="Ingredients.aspx">عربي</a></li>
            </ul>
        </li>
</asp:Content>
        ...
        <div class="module-body">   
            ...
            <!-- head -->
              ...
              <ul class="profile-tab nav nav-tabs">
                  <li ><a href="#unit" data-toggle="tab">الوحدات</a></li>
                  <li><a href="#category" data-toggle="tab">التصنيفات</a></li>      
                  <li class="active"><a href="#ingred" data-toggle="tab">الخامات</a></li>           
              </ul>
              <div class="profile-tab-content tab-content">
                      ...
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        ...
                        <div class="form-horizontal row-fluid"  dir="rtl">
                           <div class="control-group">
					        <div class="controls">	        
                                 <asp:LinkButton ID="unit_save" runat="server" CssClass="btn btn-large" OnClick="unit_save_Click" ValidationGroup="u">حفظ <i class="icon-filter shaded"></i></asp:LinkButton>
                            </div>
				          </div>
                       <div class="control-group">
					        <label class="control-label" for="unit_nameAr">إسم الوحدة</label>
					        <div class="controls">	        
                                <asp:TextBox ID="unit_nameAr" runat="server" Width="160px" CssClass="span8" ValidationGroup="u"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Unit name" ControlToValidate="unit_nameAr" Text="*" ForeColor="Red" ValidationGroup="u"></asp:RequiredFieldValidator>
                                 </div>
				          </div>
                           <div class="control-group">
					        <label class="control-label" for="unit_name">إسم(English)</label>
					        <div class="controls">	        
                                <asp:TextBox ID="unit_name" runat="server" Width="160px" CssClass="span8" ValidationGroup="u"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Unit name" ControlToValidate="unit_name" Text="*" ForeColor="Red" ValidationGroup="u"></asp:RequiredFieldValidator>
                                 </div>
				          </div>
                       </div>
                       <br />
                              ...
                              <asp:GridView ID="GridView_units" runat="server" 
                               ...
                               <Columns>
                                   ...
                                   <asp:TemplateField>
                                       <ItemTemplate>
                                           <asp:LinkButton ID="lnkRemove" runat="server" CommandArgument = '<%# Eval("Unit_ID")%>' OnClientClick = "return confirm('لا يمكن الحذف في حالة الاستخدام')" OnClick = "DeleteUnit">حذف</asp:LinkButton>
                                       </ItemTemplate>
                                   </asp:TemplateField>
                               </Columns>
                           </asp:GridView>  
                  ...
                  <div class="tab-pane fade" id="category">
                      ...
                      <div class="form-horizontal row-fluid" dir="rtl">
                       ...
                       <div class="control-group">
					        <label class="control-label" for="cat_name">إسم التصنيف</label>
					        <div class="controls">	        
                            ...
                            <div class="control-group">
					        <label class="control-label" for="cat_nameAr">إسم(English)</label>
					        <div class="controls">	        
                                <asp:TextBox ID="cat_name" runat="server" Width="160px" CssClass="span8" ValidationGroup="c"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Category name" ControlToValidate="cat_name" Text="*" ForeColor="Red" ValidationGroup="c"></asp:RequiredFieldValidator>
                                 </div>
				          </div>
                       </div>
                       <br />
                              ...
                              <asp:GridView ID="GridView_cats" runat="server" 
                               ...
                               <Columns>
                                   ...
                                   <asp:TemplateField>
                                       <ItemTemplate>
                                           <asp:LinkButton ID="lnkRemove" runat="server" CommandArgument = '<%# Eval("IngredientCat_ID")%>' OnClientClick = "return confirm('لا يمكن الحذف في حالة الاستخدام')" OnClick = "DeleteCat">حذف</asp:LinkButton>
                                       </ItemTemplate>
                                   </asp:TemplateField>
                               </Columns>
                           </asp:GridView>
                   ...
                   <div class="tab-pane fade active in" id="ingred">
                      <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        ...
                        <div class="form-horizontal row-fluid" dir="rtl">
                            <div class="control-group">
					            <div class="controls">
                                    <asp:LinkButton ID="item_new_" runat="server" CssClass="btn btn-large" OnClick="item_new__Click">جديد <i class="icon-file shaded"></i></asp:LinkButton>
                                    <asp:LinkButton ID="item_save_" runat="server" CssClass="btn btn-large" OnClick="item_save__Click">حفظ <i class="icon-save shaded"></i></asp:LinkButton>
                                    <asp:LinkButton ID="item_update_" runat="server" CssClass="btn btn-large" Visible="false" OnClick="item_update__Click">تعديل <i class="icon-edit shaded"></i></asp:LinkButton>						
                                    <asp:LinkButton ID="item_delete_" runat="server" CssClass="btn btn-large" Visible="false" OnClientClick = "return confirm('لا يمكن الحذف في حالة الاستخدام')" OnClick="item_delete__Click">حذف <i class="icon-cut shaded"></i></asp:LinkButton>                                     
                                </div>
				            </div>
                           <div class="control-group">
					        <label class="control-label" for="item_cat">تصنيف</label>
					        <div class="controls">
                             ...
                             <div class="control-group">
					        <label class="control-label" for="item_nameAr">اسم الصنف</label>
					        <div class="controls">						        
                           ...
                           <div class="control-group">
					        <label class="control-label" for="item_name">إسم(English)</label>
					        <div class="controls">						        
                            ...
                            <div class="control-group">
					        <label class="control-label" for="item_expiredate">السعر</label>
					        <div class="controls">                                
                             ...
                             <div class="control-group">
					        <label class="control-label" for="item_unit">الوحدة</label>
					        <div class="controls">
                              ...
                              <asp:GridView ID="GridView_items" runat="server" AutoGenerateColumns="False" 
                                  ...
                                  <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="تصنيف">
                                          <ItemTemplate>
                                              <asp:Label ID="LblIngredcat" runat="server" Text='<%# Bind("IngredientCat_NameAr") %>'></asp:Label>
                                          </ItemTemplate>
                                      </asp:TemplateField>
