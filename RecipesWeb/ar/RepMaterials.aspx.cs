...
public partial class ar_RepMaterials : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            if (Session["LoginCom"] != null && Session["LoginUser"] != null)
            {
                ...
                if (dtpriv.Rows.Count > 0)
                {
                    ...
                    Matcosts_cat.DataTextField = "IngredientCat_NameAr";
                    ...
                    Matpriceshis_cat.DataTextField = "IngredientCat_NameAr";
    ...
    private void BindData()
    {
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-ar_RepMaterials-BindData");
        }
    }
    ...
    protected void Matcosts_print_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Matcosts_bycat.Checked)
            {
                ...
                Response.Redirect("~/ar/Reports/MaterialGenerate.aspx?cat=" + cat + "&" + "type=" + type);
            }
            else if (Matcosts_byname.Checked)
            {
                type = "byname";
                name = Matcosts_itemname.Text;
                Response.Redirect("~/ar/Reports/MaterialGenerate.aspx?name=" + name + "&" + "type=" + type);
            }
            else if (Matcosts_all.Checked)
            {
                type = "all";
                Response.Redirect("~/ar/Reports/MaterialGenerate.aspx?type=" + type);
            }
        }
        catch (Exception ex)
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-ar_RepMaterials-Matcosts_print_Click");
        }
    }
    ...
    protected void GridView_items_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-ar_RepMaterials-GridView_items_PageIndexChanging");
        }
    }
    ...
    protected void Matpriceshis_query_Click(object sender, EventArgs e)
    {
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-ar_RepMaterials-Matpriceshis_query_Click");
        }
    }
    protected void Matpriceshis_print_Click(object sender, EventArgs e)
    {
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-ar_RepMaterials-Matpriceshis_print_Click");
        }
    }
    protected void Matpriceshis_cat_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            Matpriceshis_name.DataTextField = "Ingredient_NameAr";
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-ar_RepMaterials-Matpriceshis_cat_SelectedIndexChanged");
        }
    }
}