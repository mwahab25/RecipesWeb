...
public partial class ar_MakeIngredient : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            if (Session["LoginCom"] != null && Session["LoginUser"] != null)
            {
                ...
                if (dtpriv.Rows.Count > 0)
                {
                    ...
                    batch_unit.DataTextField = "Unit_NameAr";
                    ...
                    batch_batchcat.DataTextField = "IngredientCat_NameAr";
    ...
    protected void batch_print_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("~/ar/Reports/BatchGenerate.aspx?id=" + batch_no.Text);
        }
        catch (Exception ex)
        {
    ...
    protected void batch_batchcat_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            batch_ingredname.DataTextField = "Ingredient_NameAr";
        ...
        {
            con.ExcutehostProc(Com_username, "Log_Issues", new string[] { "msg", "details" }, ex.Message, "Err-MakeIngredient-batch_batchcat_SelectedIndexChanged");
        }
    }
